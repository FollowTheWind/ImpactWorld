...
public class HealthBar : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        GUI.Box(new Rect(pos.x - 51, Screen.height - pos.y - 120, Combat.maxHealth, 7), ".", backStyle);
        //GUI.Box(new Rect(pos.x - 26, Screen.height - pos.y + 20, Combat.maxHealth / 2, 7), ".", backStyle);

        // draw health bar amount (green)
        GUI.color = Color.green;
        GUI.backgroundColor = Color.green;
        GUI.Box(new Rect(pos.x - 50, Screen.height - pos.y - 121, combat.health, 5), ".", healthStyle);
